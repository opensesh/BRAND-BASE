          ...
          {leftOpen && (
            <div className="bg-brand-charcoal px-6 py-8 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full bg-brand-vanilla text-brand-charcoal rounded-full px-4 py-3 font-text text-button flex items-center justify-center gap-2 hover:bg-brand-aperol hover:text-brand-vanilla transition-colors">
                  More Info
              ...
              <div className="space-y-4">
                ...
                <button className="w-full border border-brand-vanilla text-brand-vanilla rounded-full px-4 py-3 font-text text-button flex items-center justify-center gap-2 hover:bg-brand-vanilla hover:text-brand-charcoal transition-colors">
                  Get in Touch
