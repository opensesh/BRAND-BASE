      ...
      >
        <div className="px-8 py-6 flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            <h3 className="text-label text-brand-vanilla">On this page</h3>
          </div>
            ...
            {navItems.map((item) => (
              <div key={item.id}>
                ...
                >
                  ...
                  <span className={`text-h3 flex-shrink-0 ${
                  ...
                  <div className="pl-8 flex flex-col gap-1 mt-3 pb-6 animate-fade-in">
                    {item.subItems.map((subItem) => (
                      ...
                      >
                        ...
                        <span className="text-b2 flex-1">{subItem.label}</span>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-caption text-brand-vanilla">Quick Links</h3>
            <div className="flex gap-2">
              <a
                href="https://www.figma.com/design/t6ibLjzJFXY6HzU0bIahxw/BRAND-OS"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 min-w-[132px] bg-white text-brand-charcoal rounded-full px-4 py-3 text-button flex items-center justify-center gap-2 hover:bg-brand-aperol hover:text-white transition-colors"
              >
                Figma
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full bg-white text-brand-charcoal rounded-full px-4 py-3 text-button flex items-center justify-center gap-2 hover:bg-brand-aperol hover:text-white transition-colors"
            >
              Guidelines
