  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'd1': ['60px', { lineHeight: '1.2', letterSpacing: '-2px', fontWeight: '700' }],
        ...
        'd2': ['38px', { lineHeight: '1.25', letterSpacing: '-0.5px', fontWeight: '500' }],
        ...
        'h2': ['28px', { lineHeight: '1.2', letterSpacing: '-0.5px', fontWeight: '700' }],
        ...
        'h4': ['22px', { lineHeight: '1.2', letterSpacing: '-0.25px', fontWeight: '600' }],
        ...
        'h5': ['20px', { lineHeight: '1.25', letterSpacing: '0', fontWeight: '400' }],
        ...
        'h6': ['18px', { lineHeight: '1.2', letterSpacing: '0', fontWeight: '600' }],
